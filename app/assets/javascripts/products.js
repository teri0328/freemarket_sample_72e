$(document).on('turbolinks:load', function(){
  $(function(){
    ...
    function setLabel() {
      ...
      if(labelWidth==620){
        $("#product_images_attributes_0_image").css("display","inline-block");
      }else{
        $("#product_images_attributes_0_image").css("display","none");
      }
    }
...
//     const html = `<img data-index="${index}" src="${url}" width="20%" height="100px">`;
//     return html;
//   }
